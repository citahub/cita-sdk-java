...
public class Token extends Contract {
    ...
    public Flowable<TransferEventResponse> transferEventFlowable(DefaultBlockParameter startBlock, DefaultBlockParameter endBlock) {
        ...
        return appChainj.appLogFlowable(filter).map(new Function<Log, TransferEventResponse>() {
            @Override
    ...
    public RemoteCall<BigInteger> balances(String param0) {
        org.nervos.appchain.abi.datatypes.Function function = new org.nervos.appchain.abi.datatypes.Function("balances",
    ...
    public RemoteCall<BigInteger> getBalance(String account) {
        org.nervos.appchain.abi.datatypes.Function function = new org.nervos.appchain.abi.datatypes.Function("getBalance",
