...
public class PermissionSystemTest {
    ...
    public static void main(String[] args) throws Exception {
        ...
        TransactionReceipt tx1 = permissionManager.grantPermission(admin.getAddress(), BigInteger.valueOf(1), quota, newNonce(), getValidUntilBlock(), BigInteger.valueOf(version),chainId, value).send();
        ...
        TransactionReceipt tx2 = permissionSystem.newGroup( Strings.asciiToHex("zz", 32),
                ...
                Strings.asciiToHex("", 32), "This is a test group", quota, newNonce(), getValidUntilBlock(), BigInteger.valueOf(version), chainId, value).send();
        ...
        TransactionReceipt tx3 = permissionManagement.newPermission(Bytes32.DEFAULT.getValue(), conts, funcs, quota, newNonce(), getValidUntilBlock(), BigInteger.valueOf(version), chainId, value).send();
