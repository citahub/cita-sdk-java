...
public class PermissionManager extends Contract {
    ...
    public RemoteCall<TransactionReceipt> grantPermission(String _user, BigInteger _permission, BigInteger quota, BigInteger nonce, BigInteger validUntilBlock, BigInteger version, Integer chainId, String value) {
    ...
    public RemoteCall<TransactionReceipt> revokePermission(String _user, BigInteger _permission, BigInteger quota, BigInteger nonce, BigInteger validUntilBlock, BigInteger version, Integer chainId, String value) {
        Function function = new Function(
                "revokePermission",
                Arrays.<Type>asList(new org.web3j.abi.datatypes.Address(_user),
                        new org.web3j.abi.datatypes.generated.Uint8(_permission)),
    ...
    public static RemoteCall<PermissionManager> deploy(Web3j web3j, TransactionManager transactionManager, BigInteger quota, BigInteger nonce, BigInteger validUntilBlock, BigInteger version, String value, Integer chainId, List<String> _senders, List<String> _creators) {
        ...
        return deployRemoteCall(PermissionManager.class, web3j, transactionManager, quota, nonce, validUntilBlock, version, chainId, value, BINARY, encodedConstructor);
    }
