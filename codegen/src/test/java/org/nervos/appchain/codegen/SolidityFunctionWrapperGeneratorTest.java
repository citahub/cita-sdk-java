...
import static org.nervos.appchain.codegen.SolidityFunctionWrapperGenerator.JAVA_TYPES_ARG;
import static org.nervos.appchain.codegen.SolidityFunctionWrapperGenerator.SOLIDITY_TYPES_ARG;
import static org.nervos.appchain.codegen.SolidityFunctionWrapperGenerator.getFileNameNoExtension;
...
public class SolidityFunctionWrapperGeneratorTest extends TempFileProvider {
    ...
    private void testCodeGenerationSolidityTypes(
        ...
        testCodeGeneration(
                ...
                "org.appChainj.unittests.solidity", SOLIDITY_TYPES_ARG);
    }
