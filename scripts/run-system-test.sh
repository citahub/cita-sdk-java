...
test -e console/build/libs/cita-sdk-*-all.jar ||  echo "build sdk failed !!!"
test -e console/build/libs/cita-sdk-*-all.jar ||  exit 1
...
cp cita-sdk-java/console/build/libs/cita-sdk-*-all.jar  ./cita_quality/systemTest/cita-sdk.jar
...
CITA_SDK_LOCAL_FILE_PATH=${system_test_dir}/cita-sdk-${CITA_SDk_VERSION}-all.jar
